...
(1, '', '', 'club TONKOTSU', 'tonkotsu@tonkotsu.com', 'hiphopr&b', 'ダンスフロアにこだわったクラブです。', '$2y$10$h9keZed/qNM31M66JXIrk.O5ggzGzQiFCzqqjNJ3g/3jOq4zqBZ2q'),
(2, '', '', 'bar G\'s FUKUOKA', 'gs@tonkotsu.com', 'EDM', 'GEEKが集まるお店です。', '$2y$10$oW9J5Dyr/Z.gBOR7cwS1N.1JdHpa/37H2C3CNhfpS.68mIDpJpHxe'),
...
INSERT INTO `todo_table` (`id`, `image`, `extension`, `name`, `email`, `genre`, `profile`, `URL`, `password`) VALUES
